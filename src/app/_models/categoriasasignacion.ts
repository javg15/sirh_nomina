...
export default interface Categoriaspercdeducpermitidas {
  id: number | null;

  id_categorias: number | null;

  id_catpercdeduc: number | null;

  tipopercdeduc: string | null;
...
/*export interface CategoriaspercdeducpermitidasInitializer {
  id?: number;
  ...
  id_categoriaspercdeducpermitidasasociado?: number;
