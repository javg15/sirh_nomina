...
export class OrdinariosService {
  ...
  public getAdmin(dataTablesParameters): Observable<any> {
    return this.http.post(this.API_URL + '/calculoprincipal/getAdmin',
      { dataTablesParameters }
      , httpOptions);
  }

  /* El siguiente método lee los datos de un registro seleccionado para edición. */
  public getCalculado(id: any): Observable<any> {
    return this.http.post(this.API_URL + '/calculoprincipal/getCalculado',
      { id }
      , httpOptions);
  }
  ...
  public ejecutarCalculo(dataPack, actionForm): Observable<any> {
    ...
    return this.http.post(this.API_URL + '/calculoprincipal/ejecutarCalculo',
      { dataPack, actionForm }
      , httpOptions);
  }
