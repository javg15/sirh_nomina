...
@Component({
  selector: 'app-retroactivos-admin',
  templateUrl: './retroactivos-admin.component.html',
  styleUrls: ['./retroactivos-admin.component.css']
})


export class RetroactivosAdminComponent implements OnInit {
  ...
  private dtOptionsAdicional = {
    ...
    raw:0
    ,fkey:'id_catquincena_aplicacion'
    ,fkeyvalue:[0]
    ,modo:22
  };
  ...
  record_id_catquincena_retroactiva:number=0;
  ...
  /* En el constructor creamos el objeto retroactivosService,
  ...
  constructor(
    ...
    private retroactivosService: RetroactivosService, private route: ActivatedRoute,
    private catquincenaSvc: CatquincenaService,
    private _sanitizer: DomSanitizer
  ) {
    this.catquincenaSvc.getCatalogoRetroactivo().subscribe(resp => {
      this.catquincenaCat = resp;
      this.record_id_catquincena_retroactiva=resp[0].id;
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        dataTablesParameters.opcionesAdicionales = this.dtOptionsAdicional;
          ...
          this.retroactivosService.http
            .post<DataTablesResponse>(
              // this.API_URL + '/a6b_apis/read_records_dt.php',
              this.API_URL + '/retroactivos/getAdmin',
  ...
  openModal(id: string, accion: string, idItem: number) {
    this.retroactivosService.open(id, accion, idItem);
  }

  closeModal(id: string) {
    this.retroactivosService.close(id);
  }
  ...
  onSelectQuincena(idx, id_campo) {
    this.dtOptionsAdicional.fkeyvalue=[
      (this.record_id_catquincena_retroactiva==null?0:this.record_id_catquincena_retroactiva),
    ];
