...
@Component({
  selector: 'app-catpercepciones-admin',
  templateUrl: './catpercepciones-admin.component.html',

})


export class CatpercepcionesAdminComponent implements OnInit {
  ...
  nombreModulo = 'Catpercepciones';

  headersAdmin: any;

  /* En el constructor creamos el objeto catpercepcionesService,
  ...
  constructor(
    private catpercepcionesService: CatpercepcionesService,private route: ActivatedRoute
  ) {
    ...
    this.headersAdmin = JSON.parse(this.route.snapshot.data.userdata.cabeceras);
      ...
      this.dtOptions = {
        ...
        ajax: (dataTablesParameters: any, callback) => {
          ...
          this.catpercepcionesService.http
  ...
  openModal(id: string, accion: string, idItem: number) {
    this.catpercepcionesService.open(id, accion, idItem);
  }

  closeModal(id: string) {
    this.catpercepcionesService.close(id);
  }
