...
export class CatpercepcionesService {
  ...
  public getCatalogoSegunPersonal(id_personal: any): Observable<any> {
    return this.http.post(this.API_URL + '/catpercepciones/getCatalogoSegunPersonal',
      { id_personal }
      , httpOptions);
  }
  public getCatalogoOpen(id_catzonageografica,id_catpercepciones): Observable<any> {
    return this.http.post(this.API_URL + '/catpercepciones/getCatalogoOpen',
      { id_catzonageografica,id_catpercepciones }
      , httpOptions);
  }
  ...
  public setRecord2(dataPack, campoEdit): Observable<any> {
    ...
    return this.http.post(this.API_URL + '/catpercepciones/setRecord2',
      { dataPack, campoEdit }
      , httpOptions);
  }

  public getCatalogoSinAdmin(id_usuario:number): Observable<any> {
    return this.http.post(this.API_URL + '/catpercepciones/getCatalogoSinAdmin',
      {id_usuario}
      , httpOptions);
  }
