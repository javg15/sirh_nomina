...
export class CategoriasasignacionpercService {
  ...
  public getAdmin(dataTablesParameters): Observable<any> {
    return this.http.post(this.API_URL + '/categoriasasignacion/getAdminPerc',
  ...
  public open(id: string, accion: string, idItem: number,tipopercdeduc:string) {
    let modal: any = this.modals.filter(x => x.id === id)[0];
    modal.open(idItem, accion,tipopercdeduc);
  }
