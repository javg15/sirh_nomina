...
@Component({
  selector: 'app-categoriasasignacion-admin',
  templateUrl: './categoriasasignacion-admin.component.html',

})


export class CategoriasasignacionAdminComponent implements OnInit {
  ...
  nombreModulo = 'Categoriasasignacion';

  headersAdmin: any;

  /* En el constructor creamos el objeto categoriasasignacionService,
  ...
  constructor(
    private categoriasasignacionService: CategoriasasignacionService,private route: ActivatedRoute
  ) {
    ...
    this.headersAdmin = JSON.parse(this.route.snapshot.data.userdata.cabeceras);
      ...
      this.dtOptions = {
        ...
        ajax: (dataTablesParameters: any, callback) => {
          ...
          this.categoriasasignacionService.http
  ...
  openModal(id: string, accion: string, idItem: number) {
    this.categoriasasignacionService.open(id, accion, idItem);
  }

  closeModal(id: string) {
    this.categoriasasignacionService.close(id);
  }
