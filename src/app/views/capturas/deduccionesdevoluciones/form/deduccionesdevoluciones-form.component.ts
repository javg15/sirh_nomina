...
export class DeduccionesdevolucionesFormComponent implements OnInit, OnDestroy {
  ...
  record_id_catquincena_fin:number=0;
 
  keywordSearch = 'full_name';
  isLoadingSearch: boolean;
  record_personal:any;
  editarDias:boolean=false;
...
refreshFields() {
 ...
 // console.log("this.formQuincenas.controls=>",this.fieldsQuincenas)
  ...
  Recalcular(){
    let quincena_fin=this.record.id_catquincena_aplicacion-3
      - (this.record_restarquincenas*3)
    let quincena_ini=quincena_fin - ((this.record_quincenasadeudadas-1)*3);
    
    this.record.id_catquincena=quincena_ini;
    this.record_id_catquincena_fin=quincena_fin;
