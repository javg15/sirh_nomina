...
import { Percepcionescaptura,  Personal,Catquincena } from '../../../../_models';
...
@Component({
  selector: 'app-percepcionescaptura-admin',
  templateUrl: './percepcionescaptura-admin.component.html',
  styleUrls: ['./percepcionescaptura-admin.component.css']
})


export class PercepcionescapturaAdminComponent implements OnInit {
  ...
  /* En el constructor creamos el objeto percepcionescapturaService,
  ...
  constructor(
    ...
    private percepcionescapturaService: PercepcionescapturaService, private route: ActivatedRoute,
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        dataTablesParameters.opcionesAdicionales = this.dtOptionsAdicional;
          ...
          this.percepcionescapturaService.http
  ...
  openModal(id: string, accion: string, idItem: number) {
    this.percepcionescapturaService.open(id, accion, idItem);
  }

  closeModal(id: string) {
    this.percepcionescapturaService.close(id);
  }
