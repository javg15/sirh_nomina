...
import { Deduccionescaptura,  Personal,Catquincena } from '../../../../_models';
...
@Component({
  selector: 'app-deduccionescaptura-admin',
  templateUrl: './deduccionescaptura-admin.component.html',
  styleUrls: ['./deduccionescaptura-admin.component.css']
})


export class DeduccionescapturaAdminComponent implements OnInit {
  ...
  /* En el constructor creamos el objeto deduccionescapturaService,
  ...
  constructor(
    ...
    private deduccionescapturaService: DeduccionescapturaService, private route: ActivatedRoute,
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        dataTablesParameters.opcionesAdicionales = this.dtOptionsAdicional;
          ...
          this.deduccionescapturaService.http
  ...
  openModal(id: string, accion: string, idItem: number) {
    this.deduccionescapturaService.open(id, accion, idItem);
  }

  closeModal(id: string) {
    this.deduccionescapturaService.close(id);
  }
