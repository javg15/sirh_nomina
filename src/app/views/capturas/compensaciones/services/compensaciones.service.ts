...
export class CompensacionesService {
  ...
  public getAdmin(dataTablesParameters): Observable<any> {
    return this.http.post(this.API_URL + '/compensaciones/getAdmin',
  ...
  public getRecord(id: any): Observable<any> {
    return this.http.post(this.API_URL + '/compensaciones/getRecord',
      { id }
      , httpOptions);
  }
  ...
  public setRecord(dataPack, actionForm): Observable<any> {
    ...
    return this.http.post(this.API_URL + '/compensaciones/setRecord',
      { dataPack, actionForm }
      , httpOptions);
  }
