...
@Component({
  selector: 'app-compensaciones-admin',
  templateUrl: './compensaciones-admin.component.html',
  styleUrls: ['./compensaciones-admin.component.css']
})


export class CompensacionesAdminComponent implements OnInit {
  ...
  record:Compensaciones={
    ...
    id_catcompensacionestipos: 0, id_catfondopresupuestal: 0, id_catquincena_ini: 0, 
    id_catquincena_fin: 0, observaciones: '', id_catquincena_aplicacion: 0,
    id_plazas: 0, clavecobro: '', ignorarempparapasivos: 0,
    ignorarreciboparadecanual: 0, fecharealpago: null, compensacionesustitucion: 0,  
    recibotimbrado: 0, aniopasivos: '', pagatercero: 0,  
    id_personal_beneficiario: 0, definirperiododiferente:0,
  ...
  /* En el constructor creamos el objeto compensacionesService,
  ...
  constructor(
    ...
    private compensacionesService: CompensacionesService, private route: ActivatedRoute,
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        dataTablesParameters.opcionesAdicionales = this.dtOptionsAdicional;
          ...
          this.compensacionesService.http
            .post<DataTablesResponse>(
              // this.API_URL + '/a6b_apis/read_records_dt.php',
              this.API_URL + '/compensaciones/getAdmin',
  ...
  openModal(id: string, accion: string, idItem: number) {
    this.compensacionesService.open(id, accion, idItem);
  }

  closeModal(id: string) {
    this.compensacionesService.close(id);
  }
