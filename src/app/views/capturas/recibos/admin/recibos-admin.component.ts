...
import { Recibos,  Personal,Catquincena } from '../../../../_models';
...
export class RecibosAdminComponent implements OnInit {
  ...
  record:Recibos={
    ...
    id_catrecibostipos: 0, id_catfondopresupuestal: 0, id_catquincena_ini: 0, 
    id_catquincena_fin: 0, observaciones: '', id_catquincena_aplicacion: 0,
    id_plazas: 0, clavecobro: '', ignorarempparapasivos: 0,
    ignorarreciboparadecanual: 0, fecharealpago: null, recibosustitucion: 0,  
  ...
  /* En el constructor creamos el objeto recibosService,
  ...
  constructor(
    ...
    private recibosService: RecibosService, private route: ActivatedRoute,
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        dataTablesParameters.opcionesAdicionales = this.dtOptionsAdicional;
          ...
          this.recibosService.http
            .post<DataTablesResponse>(
              // this.API_URL + '/a6b_apis/read_records_dt.php',
              this.API_URL + '/recibos/getAdmin',
  ...
  openModal(id: string, accion: string, idItem: number) {
    this.recibosService.open(id, accion, idItem);
  }

  closeModal(id: string) {
    this.recibosService.close(id);
  }
