...
export class RecibosService {
  ...
  public getAdmin(dataTablesParameters): Observable<any> {
    return this.http.post(this.API_URL + '/recibos/getAdmin',
  ...
  public getRecord(id: any): Observable<any> {
    return this.http.post(this.API_URL + '/recibos/getRecord',
      { id }
      , httpOptions);
  }
  ...
  public setRecord(dataPack, actionForm): Observable<any> {
    ...
    return this.http.post(this.API_URL + '/recibos/setRecord',
      { dataPack, actionForm }
      , httpOptions);
  }
